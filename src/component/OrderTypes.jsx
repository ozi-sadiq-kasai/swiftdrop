...
const renderIcons = icons.map((icon, index) => (
  <div key={icon.name}>
    ...
    <p 
     className="text-center xsm:text-[10px] hover:text-green-400 cursor-pointer">
      {icon.name}
    </p>
  </div>
))
...
const OrderTypes = () => {
  ...
  return (
    <div className="w-screen h-dvh">
      ...
      <div  
      className="flex justify-around items-center flex-wrap xsm:justify-evenly xsm:gap-2 my-8">
        {renderIcons}
      </div>
      <OrderPlaces />
